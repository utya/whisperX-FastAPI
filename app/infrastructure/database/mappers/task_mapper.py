...
def to_domain(orm_task: ORMTask) -> DomainTask:
    ...
    return DomainTask(
        ...
        partial_speaker_count=orm_task.partial_speaker_count,
        partial_speakers=orm_task.partial_speakers,
...
def to_orm(domain_task: DomainTask) -> ORMTask:
    ...
    orm_task = ORMTask(
        ...
        partial_speaker_count=domain_task.partial_speaker_count,
        partial_speakers=domain_task.partial_speakers,
